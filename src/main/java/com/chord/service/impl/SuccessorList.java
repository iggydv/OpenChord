...
final class SuccessorList {
     ...
     *
     * @param localID         This node's ID; is used for comparison operations of other
     *                        node references.
     * @param numberOfEntries Number of entries to be stored in this successor list.
     * @param parent          Reference on this objects parent.
     * @param entries         Reference on the entry repository for replication purposes.
     */
     ...
     *
     * @param nodeToAdd Reference to be added.
     * @throws NullPointerException If node to add is <code>null</code>.
     */
     ...
     *
     * @param nodeToDelete Reference to be removed.
     ...
     *
     * @param idToLookup ID of which closest preceding node is sought-after.
     * @return Reference on closest preceding node of given ID.
     * @throws NullPointerException If ID to look up is <code>null</code>.
     */
     ...
     *
     * @param nodeToLookup Reference to look up.
     * @return <code>true</code>, if reference is contained, and
     * <code>false</code>, else.
     * @throws NullPointerException If node to look up is <code>null</code>.
     */
