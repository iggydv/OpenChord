...
public final class ID implements Comparable<ID>, Serializable {
     ...
     * <code>com.chord.data.ID.displayed.representation</code>.
     ...
     * <code>com.chord.data.ID.number.of.displayed.bytes</code>.
     */
     ...
     *
     * @param id1 Byte array containing the ID.
     */
    public ID(byte[] id1) {
     ...
     *
     * @param powerOfTwo Power of two which is added to the current ID. Must be a value
     ...
     *
     * @param equalsTo Object to check equality with this {@link ID}.
     */
