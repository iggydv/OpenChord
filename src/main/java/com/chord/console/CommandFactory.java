...
public class CommandFactory {
     ...
     *
     * @param out            The PrintStream, to that all {@link Command}s created by this
     *                       factory, print their output to.
     * @param toCommand      The Objects to execute commands on.
     * @param commandMapping The mapping from command name to command class. This must not
     ...
     *
     * @param commandLine The command line entered into the console (See
     *                    {@link ConsoleThread}).
     * @return The instance of the command corresponding to given commandLine.
     * @throws ConsoleException Any Exception during creation of command.
     */
