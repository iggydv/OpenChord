...
public final class SocketProxy extends Proxy implements Runnable {
     ...
     */
    private final static Logger logger = LoggerFactory.getLogger(SocketProxy.class);
    ...
    public void ping() throws CommunicationException {
        ...
        boolean debugEnabled = SocketProxy.logger.isDebugEnabled();
    ...
    public void run() {
        while (!this.disconnected) {
            try {
                ...
                logger.error("ClassNotFoundException occured during deserialization "
